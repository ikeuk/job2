...
<div class="container">
  ...
  <input type="hidden" class="form-control" id="name" name="id" value="{{$posts->id}}" required>
                    ...
                    <button type="submit" id="complete-order" class="button-primary full-width">Update</button>&nbsp;
                     <a href="/job/post/index" class="btn btn-default">Go Back</a>
                </form>
<a href="/job/post/delete/{{$posts->id}}" class="btn btn-default" onclick="return confirm('Are you sure you want to delete this item')">Delete</a>
            </div>
